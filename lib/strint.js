...
(function() {
	...
	e.div = function (dividend, divisor, floorNeg = false) {
		...
		if (floorNeg && !eq(mul(absResult, divisor), dividend) && isNegative(absResult)) absResult = sub(absResult, '1');
		return absResult;
	};
...
e.BYTE_SHIFT = '256'; //stores the value needed to multiply an integer to shift it left 8 bits - for big int math
module.exports = e;