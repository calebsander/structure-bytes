...
assert.equal(type.toBuffer(), Buffer.from([0x55, 0x51, 2, 8, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x46, 0x74, 0x20, 8, 0x73, 0x70, 0x65, 0x65, 0x64, 0x4d, 0x70, 0x68, 0x11, 2, 0x40, 0xc0, 0x00, 0x00, 28, 0x40, 0x40, 0x00, 0x00, 70]));
assert.equal(r.type(type.toBuffer()), type);