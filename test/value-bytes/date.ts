...
export = () => {
	...
	assert.deepEqual(new Uint8Array(gb.toBuffer()), bufferFrom([0, 0, 0x01, 0x55, 0xea, 0x5f, 0xf7, 0x0b]))
	...
	assert.deepEqual(new Uint8Array(beforeBuffer), bufferFrom([0xff, 0xff, 0xff, 0xff, 0xfa, 0xd9, 0xa4, 0x00]))
